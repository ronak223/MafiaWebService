...
print "======================================="
r = requests.get('http://mafia-web-service.herokuapp.com/createPlayer/' + main_user + '/' + '100/-100/' + 'Werewolf', auth=(main_user, main_password))
...
r = requests.get('http://mafia-web-service.herokuapp.com/login/' + main_user + '/' + main_password)
r = requests.get('http://mafia-web-service.herokuapp.com/createPlayer/ronak223/' + '98/-99/' + 'Townsperson', auth=(main_user, main_password))
r = requests.get('http://mafia-web-service.herokuapp.com/createPlayer/testuser/' + '75/-75/' + 'Townsperson', auth=(main_user, main_password))
...
r = requests.get('http://mafia-web-service.herokuapp.com/playersNearTo/' + main_user + '/5', auth=(main_user, main_password))
...
r = requests.get('http://mafia-web-service.herokuapp.com/playersNearTo/' + main_user + '/50', auth=(main_user, main_password))
print "The following are the players found:"
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/startGame/' + main_user + '/' + freq, auth=(main_user, main_password))
print r.content
...
print "======================================="
freq = raw_input("Please input a frequency you would like the game to play on: ")
r = requests.get('http://mafia-web-service.herokuapp.com/restartGame/' + main_user + '/' + freq, auth=(main_user, main_password))
print r.content
print
...
print "======================================="
r = requests.get('http://mafia-web-service.herokuapp.com/getAllAlivePlayers', auth=(main_user, main_password))
print r.content
print
...
print "======================================="
r = requests.get('http://mafia-web-service.herokuapp.com/getAllVotablePlayers', auth=(main_user, main_password))
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/killPlayer/' + main_user + '/' + 'ronak223', auth=(main_user, main_password))
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/placeVote/testuser/' + main_user, auth=(main_user, main_password))
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/placeVote/' + main_user + '/testuser', auth=(main_user, main_password))
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/getCurrentLocation/' + main_user, auth=(main_user, main_password))
print r.content
print
...
r = requests.get('http://mafia-web-service.herokuapp.com/getHighscore', auth=(main_user, main_password))
print r.content
print
